...
public class StudentRestService {
	...
	/**
	 * GET方式返回jsonp格式数据
	 * http://localhost:8080/v1/api/student/jsonp/1
	 * @param id
	 * @return
	 */
	@GET
	...
	public Response getStudentInJsonp(@PathParam("id") int id) {
 
		Student student = new Student(id,"SCOTT");
		return Response.ok(student, "application/javascript").build();
